...
import adapter.Food5_Detail_Adapter;
import adapter.Food5_Detail_Adapter2;
import adapter.FoodPagerAdapter;
import me.relex.circleindicator.CircleIndicator;
import model.Food5_Detail_Model;
import model.Food5_Detail_Model2;

public class Food5_detail extends AppCompatActivity {
...
//viewpager code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food5_detail);


        recyclerView = findViewById(R.id.RecyclerView_Food5_Detail_Id);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Food5_detail.this,LinearLayoutManager.HORIZONTAL,false);
        ...
        food5_detail_adapter = new Food5_Detail_Adapter(Food5_detail.this,modelArrayList);
        recyclerView.setAdapter(food5_detail_adapter);

//Recycle 2

        recyclerView = findViewById(R.id.RecyclerView2_Food5_Detail_Id);
        RecyclerView.LayoutManager layoutManager1 = new LinearLayoutManager(Food5_detail.this);
        ...
        food5_detail_adapter2 = new Food5_Detail_Adapter2(Food5_detail.this,modelArrayList2);
