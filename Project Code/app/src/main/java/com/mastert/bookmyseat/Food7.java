...
import adapter.Food7_Adapter;
import model.Food7_Model;
...
public class Food7 extends AppCompatActivity {
    ...
    Integer[] History_Id = {R.drawable.ic_history,R.drawable.ic_history,R.drawable.ic_history,R.drawable.ic_history};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Food7.this);
      ...
      for (int i=0;i<Restaurant_Id.length;i++){
          Food7_Model food7_model = new Food7_Model(Restaurant_Id[i],Address_Id[i],Reviews_Id[i],Date_Id[i],Dollar_Id[i],FoodImage_Id[i],History_Id[i]);
            ...
            food7_adapter = new Food7_Adapter(Food7.this,modelArrayList);
